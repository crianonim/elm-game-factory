...
var $author$project$Inventory$addItem = F2(
	function (inventory, _v0) {
		...
		var count = A2(
			...
			A2($elm$core$Dict$get, name, inventory)).b;
		var newAmount = amount + count;
		return A3(
			$elm$core$Dict$insert,
			name,
			_Utils_Tuple2(name, newAmount),
			inventory);
	});
...
var $author$project$Inventory$itemToString = function (_v0) {
	var name = _v0.a;
	var amount = _v0.b;
	return $elm$core$String$fromInt(amount) + (' of ' + name);
};
var $author$project$Inventory$removeItem = F2(
	function (inventory, _v0) {
		var name = _v0.a;
		var amount = _v0.b;
		var newAmount = A2(
			$elm$core$Maybe$withDefault,
			_Utils_Tuple2(name, 0),
			A2($elm$core$Dict$get, name, inventory)).b - amount;
		return (newAmount < 0) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			A3(
				$elm$core$Dict$insert,
				name,
				_Utils_Tuple2(name, newAmount),
...
var $author$project$Game$update = F2(
	function (msg, game) {
		if (msg.$ === 'Tick') {
			return $author$project$Game$tick(game);
		} else {
			var id = msg.a;
			return _Utils_update(
				game,
			...
			case 'GenerateRoll':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							roll: $elm$core$Maybe$Just(result),
							seed: seed
						}),
					$elm$core$Platform$Cmd$none);
			case 'Tick':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							game: $author$project$Game$tick(model.game)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var m = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							game: A2($author$project$Game$update, m, model.game)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Main$GenerateRoll = {$: 'GenerateRoll'};
...
var $author$project$Game$viewItem = function (_v0) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				name + (': ' + $elm$core$String$fromInt(amount)))
			]));
};
var $author$project$Game$viewInventory = function (inventory) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
			$elm$core$List$map,
			$author$project$Game$viewItem,
			$elm$core$Dict$values(inventory)));
};
var $elm$html$Html$p = _VirtualDom_node('p');
var $author$project$Game$viewLog = function (logs) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2(
...
var $author$project$Game$RemoveMachine = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Remove it')
					]))
			]));
};
var $author$project$Game$viewMachines = function (machines) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		A2($elm$core$List$map, $author$project$Game$viewMachine, machines));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$GenerateRoll)
							]),
						_List_fromArray(
							[
						...
						'Roll: ' + A2(
							$elm$core$Maybe$withDefault,
							'No rolled',
							A2($elm$core$Maybe$map, $elm$core$String$fromInt, model.roll)))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Game Turn ' + $elm$core$String$fromInt(model.game.turn)),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
						...
						$author$project$Game$viewMachines(model.game.machines))
					])),
				A2(
				$elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						$author$project$Game$viewLog(model.game.log)
					]))
			]));
};
